...
def parse_args():
    ...
    # 경로 설정
    parser.add_argument('--train-dir', default=r'D:\Project_2\DATA\깜빡catch 학습데이터\1\train', help='path to training data directory')
    parser.add_argument('--val-dir', default=r'D:\Project_2\DATA\깜빡catch 학습데이터\1\val', help='path to validation data directory')
    parser.add_argument('--save-path', default=r'D:\Project_2\code\Experiments\res\best_model.pth', help='path to save the best model checkpoint')
    ...
    parser.add_argument('--num-classes', default=7, help='number of anomaly classes; default = auto from dataset')
